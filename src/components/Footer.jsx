            ...
            <div className="row">
              <div className="col-md-3 mb-md-0 mb-4 border-left">
                ...
                <ul className="list-unstyled">
                  <li>
                    <a href="/services" className="py-1 d-block">
                      Balance Body
                    </a>
                  </li>
                  <li>
        ...
        <div className="row mt-5">
          <div className="col-md-6 col-lg-8">
            <p className="copyright">
              Copyright &copy; {currentYear} All rights reserved | This app is
              made with{" "}
              <i
              ...
              by{" "}
              <a
                href="https://github.com/your-username" // Replace with your portfolio or GitHub link
                target="_blank"
